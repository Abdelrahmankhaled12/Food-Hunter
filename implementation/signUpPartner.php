<?php
  ...
  require_once("../controllers/partnercontroller.php");
    ...
    $query="insert into partner(email,password,name,location,phone,logoname,logo,logotype,open,close,fees,time,status,description,minorder) VALUES ('$email','$password','$name','$address','01148173525','$logo_name','$logo','$logoType','$open','$close','$fees','$time','$status','$description','$minOrder')";
